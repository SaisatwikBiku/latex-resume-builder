        ...
        <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
            ...
            <button
              ...
              disabled={isCreating}
              className="h-10 w-full rounded-lg bg-slate-900 px-4 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-60 sm:min-w-44 sm:w-auto"
            >
          ...
          {isLoading ? (
            ...
            <div className="space-y-2">
              {repositories.map((repo) => (
                <div key={repo.id} className="relative flex flex-col gap-3 rounded-lg border border-slate-200 p-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  {openMenuRepoId === repo.id && (
                    <div className="absolute right-3 top-10 z-10 w-32 rounded-lg border border-slate-200 bg-white p-1 shadow-lg">
                      <button
                        onClick={() => {
